...
namespace Common.Extensions
{
    ...
    {
        public static T CreateNew<T>(this GameObject gameObject)
        {
            return gameObject.CreateNew().GetComponent<T>();
        }

        public static GameObject CreateNew(this GameObject gameObject)
        {
